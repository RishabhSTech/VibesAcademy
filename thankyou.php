...
//echo $_SESSION['txnIDfee'];

if(!isset($_GET['txnstatus']) || $_GET['txnstatus'] == ''){
...
if(isset($_GET['txnstatus'])) {
    
    
    if ($_GET['txnstatus'] == "success") {
        
        $txnIDnew =$_SESSION['txnIDfee'] ;
        $code21 = 'PAYMENT_SUCCESS';
        $providerReferenceId = 'Used free coupon code';
...
if(isset($_GET['txnstatus'])) {
   ...
   This email is to confirm your registration for this i-MBA course with The Vibes Academy. <br/>
    <br/>
In case you require further details, please contact us on hello@thevibes.academy <br/> <br/>
		...
		<div class="container">
			<div class="ThankContent">
				...
				<div>
					...
					<div>Amount: <strong>₹ 0.00</strong>  </div><br>
