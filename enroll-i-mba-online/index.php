...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
	...
	<span class="success_msg" style="display:none">🎉 You are already enrolled in our i-MBA course.</span>
		<button class="btn-submit btnClickLog" type="submit">Pay and Start Now</button>
   ...
   <span></span>
    ...
    <div class="container-fluid">
       ...
       <div class="PRLOGO">
        ...
        <ul class="marquee">
                <?php
                // Loop to generate 7 list items
                for ($i = 1; $i <= 5; $i++) {
                  ?>
   
                    <li><a href="https://www.abplive.com/brand-wire/the-best-online-platform-for-developing-and-training-influencers-who-set-social-media-trends-2695545" target="_blank"><img src="PrLogo/ABPNew.png" alt="ABP" /></a></li>
                    <li><a target="_blank" href="https://www.bhaskarhindi.com/education/vibes-academy-pioneering-positive-change-in-the-field-of-social-messaging-and-skill-training-1032784"><img src="PrLogo/DenikBhaskar.png" alt="DenikBhaskar" /></a></li>
                    <li><a target="_blank" href="https://www.educationtimes.com/article/editor-s-pick/99735357/the-vibes-academy-voices-inspiring-a-better-society"><img src="PrLogo/EducationTimes.png" alt="EducationTimes" /></a></li>
                    <li><a target="_blank" href="https://english.newsnationtv.com/brand-stories/brand-stories-english/introducing-the-vibes-academy-pioneering-positive-change-in-social-messaging-and-skill-training-259877.html"><img src="PrLogo/NewsNation.png" alt="NewsNation" /></a></li>
                    <li><a target="_blank" href="https://www.timesnownews.com/business-economy/industry/indias-vibes-academy-embarks-on-ambitious-skill-revolution-to-shape-formidable-workforce-article-110369285"><img src="PrLogo/TimesNow.png" alt="TimesNow" /></a></li>
                <?php
                }
                ?>
        ...
        <div class="row pdtb115 pdb120 bg-time">
            <div class="col-md-12">
                ...
                <p class="text-center">Limited Period Offer!</p>
            </div>
